...
class InviteTestCases(APITestCase):
    ...
    def test_invite_user(self):
        ...
        # #Accepting invite
        invite = Invite.objects.get(pokerboard_id=self.pokerboard.id, user_id=self.user2)
    ...
    def test_invite_without_passing_pokerboard(self):
        ...
        response = self.client.post(self.INVITE_URL,data=json.dumps(data),content_type='application/json')
        expected_data ={
